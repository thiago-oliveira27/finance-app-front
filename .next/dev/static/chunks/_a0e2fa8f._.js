...
"[project]/lib/exchange.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getExchangeRate(toCurrency) {
    ...
    try {
        // Busca a cotação de BRL para a moeda desejada (ex: BRL-USD)
        const response = await fetch(`https://economia.awesomeapi.com.br/json/last/BRL-${toCurrency}`);
        const data = await response.json();
        // A API retorna algo como BRLUSD: { bid: "0.20" }
        const key = `BRL${toCurrency}`;
        return parseFloat(data[key].bid);
    } catch (error) {
        console.error("Erro ao buscar cotação:", error);
        return 1; // Retorna 1 caso falhe para não quebrar os cálculos
    }
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exchange$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/exchange.ts [app-client] (ecmascript)");
...
function useFinancial() {
    ...
    const [exchangeRate, setExchangeRate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1) // Estado para armazenar a cotação
    ;
    // 1. BUSCAR DADOS
    ...
    // 1.1 ATUALIZAR COTAÇÃO QUANDO A MOEDA MUDAR
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFinancial.useEffect": ()=>{
            async function updateRate() {
                const rate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exchange$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getExchangeRate"])(data.settings.currency);
    ...
    // 1.2 TRANSAÇÕES CONVERTIDAS (MEMOIZADAS)
    const convertedTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useFinancial.useMemo[convertedTransactions]": ()=>{
            return data.transactions.map({
                "useFinancial.useMemo[convertedTransactions]": (t)=>({
                        ...t,
                        amount: t.amount * exchangeRate // Aplica a cotação dinâmica aqui
                    })
            }["useFinancial.useMemo[convertedTransactions]"]);
        }
    }["useFinancial.useMemo[convertedTransactions]"], [
    ...
    // 5. ESTATÍSTICAS COM VALORES CONVERTIDOS
    const getMonthlyStats = ()=>{
        const validTransactions = convertedTransactions.filter((t)=>!isNaN(t.date.getTime()));
    ...
    return {
        // Substituímos as transações originais pelas convertidas para o restante do app
        data: {
            ...data,
...
_s(useFinancial, "wFziig0+fWJ2d4E5D8aK6kbTpTQ=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
_s(Navigation, "0h+B63IiVHeDT9bDhB3JTwv8ebY=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
// Adicionado useEffect ao import
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
...
function Dashboard() {
    _s();
    const { data, loading, addTransaction, getMonthlyStats } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useFinancial$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFinancial"])();
    const [modalOpen, setModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Controle de montagem para evitar erros de SSR nos gráficos
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        children: "Sincronizando banco de dados..."
                    }, void 0, false, {
                        fileName: "[project]/app/page.tsx",
                        lineNumber: 57,
                        columnNumber: 11
                        ...
                        children: [
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-muted-foreground",
                                                children: "Bem-vindo, Tiago. Seus dados estão sincronizados."
                                            }, void 0, false, {
                                                fileName: "[project]/app/page.tsx",
                                                lineNumber: 72,
                                                columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-3",
                                        children: data.transactions.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "text-center py-10 border-2 border-dashed rounded-xl",
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-muted-foreground",
                                                children: "Aguardando dados do banco..."
                                            }, void 0, false, {
                                                fileName: "[project]/app/page.tsx",
                                                lineNumber: 148,
                                                columnNumber: 21
...
_s(Dashboard, "FgdeUvZsxiADdgCFBgD97zWx8iU=", false, function() {
    return [
...
//# sourceMappingURL=_a0e2fa8f._.js.map